...
Java_com_notify_NodeJS_sendMessageToNodeChannel(
        JNIEnv *env,
        jobject /* this */,
        jstring channelName,
        jstring msg) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_notify_NodeJS_registerNodeDataDirPath(
        JNIEnv *env,
        jobject /* this */,
        jstring dataDir) {
...
Java_com_notify_NodeJS_getCurrentABIName(
        JNIEnv *env,
        jobject /* this */) {
...
void rcv_message_from_node(const char* channel_name, const char* msg) {
    ...
    jclass cls2 = env->FindClass("com/notify/NodeJS");
    if (cls2 != nullptr) {
        // Find the method
...
Java_com_notify_NodeJS_startNodeWithArguments(
        JNIEnv *env,
        jobject /* this */,
